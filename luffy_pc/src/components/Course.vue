    ...
    <div class="main">
      ...
      <div class="condition">
        ...
        <div class="ordering">
          ...
          <p class="condition-result">共 个课程</p>
        </div>
        ...
        <div class="course-item" >
          ...
          <div class="course-info">
            <h3>
              ...
              <span><img src="/static/image/avatar1.svg" alt="">人已加入学习</span>
            </h3>
            <p class="teather-info"><span></span>
            </p>
            <ul class="lesson-list">
              <li >

                  <span class="lesson-title">0 | 第 节：</span>
            ...
            <div class="pay-box">
              ...
              <span class="discount-price" >￥元</span>
              <span class="discount-price" >￥元</span>
              <span class="original-price" >原价：元</span>
