# Generated by Django 3.2.12 on 2022-06-08 13:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_video', models.FileField(blank=True, max_length=255, null=True, upload_to='course', verbose_name='封面视频')),
            ],
            options={
                'verbose_name': '专题课程',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_chapters', to='course.course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chaper_lesson', to='course.coursechapter', verbose_name='课程章节')),
